let Dawn = {
    ...
    Root : function(url)
    {
        if (this.isBrowser())
        {
            const DawnServerResource = this.require("./dawn/DawnServerResource.js");
            this._instanciate_processor()._add(new DawnServerResource("dawn","dawn"));
        }
        else
        {
            const FileSystemResource = Dawn.require("./dawn/FileSystemResource.js");
